...
if pg == "🏢 About LoRRI":
    ...
    # PAGE TITLE
    st.markdown('<div class="sh">🏢 Company Overview</div>', unsafe_allow_html=True)

    st.markdown("""
    <div class="info-box">

    <b>LogisticsNow</b> is building the digital backbone of the logistics industry.
    The platform helps <b>carriers, transporters, and manufacturers</b> build a stronger
    technology-enabled transportation and logistics ecosystem.

    By leveraging the power of <b>Data Science and Artificial Intelligence</b>,
    LogisticsNow addresses key challenges faced by logistics companies such as
    inefficient routing, lack of transparency, poor asset utilization,
    and limited operational visibility.

    The LoRRI platform enables organizations to analyze transporter capabilities,
    optimize logistics procurement, and improve supply chain efficiency
    using data-driven insights.

    LogisticsNow focuses on emerging logistics markets like India,
    where there are significant opportunities to improve visibility,
    transparency, utilization, and payment efficiency across the
    ...
    # VISION SECTION
    st.markdown('<div class="sh">🌍 Our Vision</div>', unsafe_allow_html=True)

    st.markdown("""
    <div class="info-box">

    Our vision is to transform traditional logistics planning into an
    <b>AI-driven intelligent transportation ecosystem</b>.

    We aim to build a platform where logistics operations are continuously
    optimized using real-time data, advanced analytics,
    and machine learning models.

    Through the integration of AI-powered decision systems,
    LoRRI helps organizations:

    • Reduce transportation and operational costs  
    • Improve delivery timelines and service levels  
    • Increase fleet utilization efficiency  
    • Reduce environmental impact through optimized routing  
    • Enable transparent and data-driven logistics decisions  

    Ultimately, our goal is to make logistics networks
    <b>smarter, faster, and more sustainable.</b>
